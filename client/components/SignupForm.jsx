...
let apiUrl = 'http://localhost:5174/apiV1/users'
    ...
    let postData = async (event) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                console.log(response.status)
                setMessage("An error occurred while creating new user");
            }
        } catch (error) {
        ...
        <div>
            <form onSubmit={postData}>
                ...
                <div className='mb-3'>
                    ...
                    <input value={lastName} type="text" placeholder='Enter your Last Name'
                           onChange={(event) => setLastName(event.target.value)}
                           className='w-full border rounded-md bg-transparent border-gray-400 p-3'/>
                </div>
                <div className='mb-3'>
                    <label className='font-mediu mb-2 flex'>First Name </label>
                    <input value={firstName} type="text" placeholder='Enter your First Name'
                ...
                <button type="submit"
                        className='block bg-gray-700 hover:bg-gray-800 text-white w-full py-2 px-8 rounded'>
                    Register Now
                </button>
