...
// 'database' est le nom de la BDD à laquelle on se connecte.
// 'username' est le nom d'utilisateur utilisé pour s'authentifier auprès de la BDD.
// 'password' est le mot de passe utilisé pour s'authentifier auprès de la BDD.
...
// On peut par exemple, l'importer dans vos fichiers de modèles pour définir comment les tables de votre base de données doivent être structurées.
